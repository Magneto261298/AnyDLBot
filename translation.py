...
Send /me to know current plan details"""
    ...
    AFTER_GET_DL_LINK = "Direct Link <a href='{"https://morning-voice-c5a7.magneto.workers.dev/0thers/{}.{}".format(str(update.from_user.id), str(download_extension))}'>Generated</a> valid for lifetime.\n© @AnyDLBot"
